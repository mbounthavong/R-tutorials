---
title: "Sample Size estimation using the odds ratio in a case-control study"
...
The source code is available on my [GitHub site](https://github.com/mbounthavong/R-tutorials/blob/main/Sample%20size%20estimation%20for%20case-control%20trials).
```
